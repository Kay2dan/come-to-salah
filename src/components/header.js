...
const Header = ({ siteTitle, activeNavbarItem = "", onClickHandler }) => (
  <Navbar>
    <NavbarBrand>
      <NavbarItem>
        {/* <img src={brandLogo} className="logo" /> */}
        <svg version="1.1" viewBox="0 0 62.395058 96.28801" className="mosque">
          <g id="layer1">
            ...
            <MenuList key={j}>
              ...
              {section.headings.map((subHeading, i) => (
                <li key={i}>
                  <MenuLink
                    className={
                      activeNavbarItem === subHeading ? "is-active" : false
                    }
